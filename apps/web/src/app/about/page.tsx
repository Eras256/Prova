...
const content = {
  EN: {
    ...
    p3: 'Prova is open source (Apache 2.0), non-custodial, and built on Solana Attestation Service — the Foundation-backed standard. We exist to make the agentic internet trustworthy.',
  ...
  ES: {
    ...
    p3: 'Prova es código abierto (Apache 2.0), sin custodia, y construido sobre el Solana Attestation Service — el estándar respaldado por la Fundación. Existimos para hacer confiable el internet de agentes.',
  ...
  ZH: {
    ...
    p3: 'Prova 是开源的（Apache 2.0），非托管的，并建立在 Solana Attestation Service 之上——这是基金会支持的标准。我们的存在是为了让代理互联网变得可信赖。',
