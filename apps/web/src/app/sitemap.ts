...
const ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/blog/why-attestations', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/blog/sas-deep-dive', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/blog/metacomp-kya', priority: 0.6, changeFrequency: 'monthly' },
