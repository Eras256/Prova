...
const translations = {
  EN: {
    ...
    descSecurity: 'STRIDE threat model, cryptographic custody, JARGUS audit reports, and enterprise bug bounty.',
  ...
  ES: {
    ...
    descSecurity: 'Modelo de amenazas STRIDE, custodia criptográfica, reportes de auditoría JARGUS y bug bounty empresarial.',
  ...
  ZH: {
    ...
    descSecurity: 'STRIDE 威胁模型、密码学托管、JARGUS 审计报告和企业级漏洞赏金。',
