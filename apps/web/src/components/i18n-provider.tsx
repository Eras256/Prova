...
const translations = {
  EN: {
    ...
    descSecurity: 'STRIDE threat model, cryptographic custody, JARGUS audit reports (internal audit, does not substitute top-tier firms), and enterprise bug bounty.',
  ...
  ES: {
    ...
    descSecurity: 'Modelo de amenazas STRIDE, custodia criptográfica, reportes de auditoría JARGUS (auditoría interna, no sustituye a firmas top-tier) y bug bounty empresarial.',
  ...
  ZH: {
    ...
    startBuilding: '开始构建',
    live: '实时',
    shippedThisWeek: 'v1.0.0 已发布到 npm →',
    heroTitle1: '为每个',
    heroTitle2: '自主 AI 代理',
    heroTitle3: '打造的',
    heroTitle4: '法证级',
    ...
    descSecurity: 'STRIDE 威胁模型、密码学托管、JARGUS 审计报告（内部审计，不可替代顶级公司的审计）和企业级漏洞赏金。',
