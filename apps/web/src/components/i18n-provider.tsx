...
const translations = {
  EN: {
    ...
    native: 'native',
    feedFooter: 'On-chain receipts · live from devnet · verify any of them →',
    liveAttestations: 'Live attestations',
    thisSession: 'this session',
    total: 'total',
    liveOnDevnet: 'live on devnet',
    awaitingActivity: 'awaiting devnet activity',
    noAttestationsYet: 'No attestations yet on devnet.',
    ...
    descSdk: 'TypeScript SDK reference — ProvaClient on-chain + ProvaApiClient REST. Apache 2.0.',
  ...
  ES: {
    ...
    native: 'nativo',
    feedFooter: 'Recibos on-chain · en vivo desde devnet · verifica cualquiera →',
    liveAttestations: 'Atestaciones en vivo',
    thisSession: 'esta sesión',
    total: 'total',
    liveOnDevnet: 'en vivo en devnet',
    awaitingActivity: 'esperando actividad en devnet',
    noAttestationsYet: 'Aún no hay atestaciones en devnet.',
    ...
    descSdk: 'Referencia del SDK de TypeScript — ProvaClient on-chain + ProvaApiClient REST. Apache 2.0.',
  ...
  ZH: {
    ...
    openSource: '开源',
    native: '原生',
    feedFooter: '链上收据 · 来自 devnet · 随时验证 →',
    liveAttestations: '实时证明',
    thisSession: '本会话',
    total: '总计',
    liveOnDevnet: 'devnet 实时运行中',
    awaitingActivity: '等待 devnet 活动',
    noAttestationsYet: 'devnet 上还没有证明。',
    openExplorer: '打开浏览器 →',
    sAgo: '秒前',
    mAgo: '分钟前',
    hAgo: '小时前',
    ...
    descSdk: 'TypeScript SDK 参考 — 链上 ProvaClient + REST ProvaApiClient。Apache 2.0。',
